...
static cl::OptionCategory FTCat("firtool Options");
...
static cl::opt<InputFormatKind> inputFormat(
    ...
    cl::init(InputUnspecified), cl::cat(FTCat));

static cl::opt<std::string> inputFilename(cl::Positional,
                                          cl::desc("<input file>"),
                                          cl::init("-"), cl::cat(FTCat));

static cl::opt<std::string>
    outputFilename("o",
                   cl::desc("Output filename, or directory for split output"),
                   cl::value_desc("filename"), cl::init("-"), cl::cat(FTCat));

static cl::opt<bool>
    splitInputFile("split-input-file",
                   cl::desc("Split the input file into pieces and process each "
                            "chunk independently"),
                   cl::init(false), cl::Hidden, cl::cat(FTCat));
...
static cl::opt<OutputFormatKind> outputFormat(
    ...
    cl::init(OutputVerilog), cl::cat(FTCat));
...
static cl::list<std::string> inputAnnotationFilenames(
    ...
    cl::CommaSeparated, cl::value_desc("filename"), cl::cat(FTCat));
...
static cl::opt<std::string> blackBoxRootPath(
    ...
    cl::value_desc("path"), cl::init(""), cl::cat(FTCat));
