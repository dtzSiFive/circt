...
static cl::OptionCategory LSCat("llhd-sim Options");

static cl::opt<std::string> inputFilename(cl::Positional,
                                          cl::desc("<input-file>"),
                                          cl::init("-"), cl::cat(LSCat));
...
static cl::opt<int> nSteps("n", cl::desc("Set the maximum number of steps"),
                           cl::value_desc("max-steps"), cl::cat(LSCat));
...
static cl::opt<uint64_t> maxTime(
    ...
    cl::value_desc("max-time"), cl::cat(LSCat));
...
static cl::opt<std::string> root(
    ...
    cl::value_desc("root_name"), cl::init("root"), cl::cat(LSCat));
...
static cl::list<std::string>
    sharedLibs("shared-libs",
               cl::desc("Libraries to link dynamically. Specify absolute path "
                        ...
                        "Optional otherwise."),
               cl::ZeroOrMore, cl::MiscFlags::CommaSeparated, cl::cat(LSCat));
