...
// CHECK-NEXT:      input var  [3:0]                                              a,
// CHECK-NEXT:                                                                    b,
// CHECK-NEXT:      input var  [1:0]                                              c,
// CHECK-NEXT:      input var                                                     cond,
// CHECK-NEXT:      input var  [11:0][9:0][3:0]                                   array2d,
// CHECK-NEXT:      input var  [7:0]                                              uarray[0:15],
// CHECK-NEXT:                                                                postUArray,
// CHECK-NEXT:      input var  struct packed {logic [1:0] foo; logic [3:0] bar; } structA,
// CHECK-NEXT:      input var  struct packed {logic [1:0] foo; }[4:0]             arrOfStructA,
// CHECK-NEXT:      input var  [0:0]                                              array1,
// CHECK-NEXT:      output var [3:0]                                              r0,
// CHECK-NEXT:                                                                    r2,
// CHECK-NEXT:                                                                    r4,
// CHECK-NEXT:                                                                    r6,
// CHECK-NEXT:                                                                    r7,
...
// CHECK-NEXT:                                                                    r27,
// CHECK-NEXT:                                                                    r28,
// CHECK-NEXT:      output var [11:0]                                             r29,
// CHECK-NEXT:      output var [1:0]                                              r30,
// CHECK-NEXT:      output var [8:0]                                              r31,
// CHECK-NEXT:      output var [3:0]                                              r33,
// CHECK-NEXT:                                                                    r34,
// CHECK-NEXT:      output var [2:0][3:0]                                         r35,
// CHECK-NEXT:      output var [5:0][3:0]                                         r36,
// CHECK-NEXT:      output var [3:0]                                              r37,
// CHECK-NEXT:      output var [11:0]                                             r38,
// CHECK-NEXT:      output var struct packed {logic a; logic b; }                 r39,
// CHECK-NEXT:      output var [3:0][1:0]                                         r40,
// CHECK-NEXT:      output var                                                    r41[0:0],
// CHECK-NEXT:      output var struct packed {logic [0:0] a; }                    r42,
// CHECK-NEXT:      output var [3:0]                                              r43,
// CHECK-NEXT:      output var struct packed {logic [1:0] foo; logic [3:0] bar; } r44,
// CHECK-NEXT:                                                                    r45,
// CHECK-NEXT:                                                                    r46,
// CHECK-NEXT:      output var                                                    r47
// CHECK-NEXT: );
...
// CHECK-NEXT:    // input var /*Zero Width*/ arg1
// CHECK-NEXT:     );
// CHECK-EMPTY:
// CHECK-NEXT:  endmodule
...
// CHECK-NEXT:  input var  d,
// CHECK-NEXT:             e,
// CHECK-NEXT:  output var f
// CHECK-NEXT:  );
// CHECK-EMPTY:
...
// CHECK-NEXT:      input var                 w,
// CHECK-NEXT:                                x,
// CHECK-NEXT:      input var  [1:0]          i2,
// CHECK-NEXT:   // input var  /*Zero Width*/ i3,
// CHECK-NEXT:      output var                y,
// CHECK-NEXT:                                z,
// CHECK-NEXT:                                p,
// CHECK-NEXT:                                p2
// CHECK-NEXT:   );
...
// CHECK-NEXT:     output var [41:0] out
// CHECK-NEXT:   );
// CHECK-EMPTY:
...
hw.module @wires(in %in4: i4, in %in8: i8, out a: i4, out b: i8, out c: i8) {
  ...
  // CHECK-NEXT:   output var [3:0] a, //
  // CHECK-NEXT:   output var [7:0] b, //
  // CHECK-NEXT:                    c //
  // CHECK-NEXT:  );
...
// CHECK-NEXT: input var  [6:0]      in1,
// CHECK-NEXT: input var  [7:0][3:0] in2,
// CHECK-NEXT: output var [6:0]      r1,
// CHECK-NEXT: output var [31:0]     r2
// CHECK-NEXT: );
...
// CHECK-NEXT:      input var  [3:0]               a,
// CHECK-NEXT:   // input var  /*Zero Width*/      zeroBit,
// CHECK-NEXT:   // input var  [2:0]/*Zero Width*/ arrZero,
// CHECK-NEXT:      output var [3:0]               r0
// CHECK-NEXT:   // output var /*Zero Width*/      rZero
// CHECK-NEXT:   // output var [2:0]/*Zero Width*/ arrZero_0
// CHECK-NEXT:   );
// CHECK-EMPTY:
...
// CHECK-NEXT:  // input var  /*Zero Width*/ structZero,
// CHECK-NEXT:  // input var  /*Zero Width*/ structZeroNest,
// CHECK-NEXT:  // output var /*Zero Width*/ structZero_0,
// CHECK-NEXT:  // output var /*Zero Width*/ structZeroNest_0
// CHECK-NEXT: );
...
// CHECK-NEXT:   // input var  /*Zero Width*/                                                                                              in0,
// CHECK-NEXT:      input var  [31:0]                                                                                                      in1,
// CHECK-NEXT:      output var struct packed {/*z1: Zero Width;*/ logic [31:0] a; /*z2: Zero Width;*/ logic [31:0] b; /*c: Zero Width;*/ struct packed {logic [31:0] d1; /*z: Zero Width;*/ } d; } out0
// CHECK-NEXT:  );
...
// CHECK-NEXT:   // input var  /*Zero Width*/ arg0,
// CHECK-NEXT:      input var  [0:0][31:0]    arg1,
// CHECK-NEXT:      output var [31:0]         out,
// CHECK-NEXT:                            out1
// CHECK-NEXT:   // output var /*Zero Width*/ out2
// CHECK-NEXT:  );
...
// CHECK-NEXT: input var  [8:0] a,
// CHECK-NEXT:                  c,
// CHECK-NEXT: input var  [3:0] d,
// CHECK-NEXT:                  e,
// CHECK-NEXT: output var       r
// CHECK-NEXT: );
// CHECK-EMPTY:
...
// CHECK-NEXT:    input var  [1:0] in,
// CHECK-NEXT:    output var union packed { struct packed {logic a; logic [0:0] __post_padding_a;} a;logic [1:0] b;} out
...
// CHECK-NEXT:    // input var  /*Zero Width*/ in,
// CHECK-NEXT:    output var union packed {/*a: Zero Width;*/ logic [1:0] b;} out
...
// CHECK-NEXT:  input var  struct packed {logic repeat_0; logic repeat_0_0; } a,
// CHECK-NEXT:  output var struct packed {logic repeat_0; logic repeat_0_0; } r1
// CHECK-NEXT:  );
...
// CHECK-NEXT:  output var                                                    r1,
// CHECK-NEXT:                                                                r2,
// CHECK-NEXT:  output var struct packed {logic repeat_0; logic repeat_0_0; } r3, 
// CHECK-NEXT:                                                                r4
// CHECK-NEXT:  );
...
// CHECK-NEXT:   #(parameter [41:0] p1 = 42'd17) (
// CHECK-NEXT:   input var  [p1 - 1:0] arg0,
// CHECK-NEXT:   output var [p1 - 1:0] out
// CHECK-NEXT:  );
...
hw.module @parameterizedTypes<param: i32 = 1, wire: i32 = 2>
  // CHECK: input var [16:0]{{ *}}a,
  (in %a: !hw.int<17>,
  // CHECK: input var [param - 1:0]{{ *}}b
   in %b: !hw.int<#hw.param.decl.ref<"param">>,
  // CHECK: input var [$clog2($unsigned(param)) - 1:0]{{ *}}c
...
// CHECK-NEXT:   input var  [41:0][param - 1:0]        a,
// CHECK-NEXT:   input var  [N - 64'd1:0][param - 1:0] b,
// CHECK-NEXT:   output var [N - 64'd1:0][param - 1:0] c
// CHECK-NEXT:  );
...
// CHECK-NEXT: input var [41:0][11:0] a,
// CHECK-NEXT: input var [23:0][11:0] b
// CHECK-NEXT: output var [23:0][11:0] c
// CHECK-NEXT: );
...
// CHECK-NEXT:    input var  [6:0]      in1,
// CHECK-NEXT:    input var  [7:0][3:0] in2,
// CHECK-NEXT:    output var [38:0]     out
// CHECK-NEXT:  );
// CHECK-EMPTY:
...
// CHECK-NEXT:    input var union packed {logic [15:0] a; struct packed {logic [9:0] b; logic [5:0] __post_padding_b;} b;} test
// CHECK-NEXT:    output var [15:0] a,
// CHECK-NEXT:    output var [9:0] b
// CHECK-NEXT:  );
// CHECK-EMPTY:
...
// CHECK-NEXT:    input var union packed {logic [15:0] a; struct packed {logic [1:0] __pre_padding_b; logic [13:0] b;} b;} test,
// CHECK-NEXT:    output var [15:0] a,
// CHECK-NEXT:    output var [13:0] b
// CHECK-NEXT:  );
// CHECK-EMPTY:
// CHECK-NEXT:    assign a = test.a;
// CHECK-NEXT:    assign b = test.b.b;
